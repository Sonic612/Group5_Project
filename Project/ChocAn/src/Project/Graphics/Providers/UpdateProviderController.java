...
public class UpdateProviderController {
    ...
    void setErrorLabel(Label l, String str){
    	l.setText(l.getText() 
    			+ "You are missing " + str + " in your updated provider.");
    }
	...
	void onYesClick(Button button, int i){
    	button.setOnAction(new EventHandler(){
			...
			public void handle(Event arg0) {
		    	...
		    	//*ACTIVATE*op.updateProvider(new Provider(provIDField.getText(), provNameField.getText(), stAddrField.getText(), cityField.getText(), stateField.getText(), i));
			}
