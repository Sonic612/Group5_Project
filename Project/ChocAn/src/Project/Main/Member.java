...
private void setMemFName(String memFName) {
	this.memFName = memFName;
}
public String getMemLName() {
	return memLName;
}
private void setMemLName(String memLName) {
	this.memLName = memLName;
}
public String getMemStAddr() {
	return memStAddr;
}
private void setMemStAddr(String memStAddr) {
	this.memStAddr = memStAddr;
}
public String getMemCity() {
	return memCity;
}
private void setMemCity(String memCity) {
	this.memCity = memCity;
}
public String getMemSt() {
	return memSt;
}
private void setMemSt(String memSt) {
	this.memSt = memSt;
}
public int getMemZip() {
	return memZip;
}
private void setMemZip(int memZip) {
	this.memZip = memZip;
}
